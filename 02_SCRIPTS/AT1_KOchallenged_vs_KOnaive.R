...
DEG_file <- read_csv("01_DATOS/indmoraV2_CPT1_Cluster25AT1_KOchallenged_vs_KOnaive.csv")
...
pdf("volcano_AT1_KOchallenged_vs_KOnaive.pdf", width = 18, height = 15)
...
#Sinombredegenes
pdf("volcano_AT1_KOchallenged_vs_KOnaive_sin_nombres.pdf", width = 18, height = 15)
EnhancedVolcano(DEG, x = "avg_log2FC", y = "adj_P_val",
                lab = DEG$`Gene Symbol`,
                xlab = bquote(~avg_log2FC),
                ylab = bquote(~-log[10]~ adj_P_val),
