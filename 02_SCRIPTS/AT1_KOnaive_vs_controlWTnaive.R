...
DEG_file <- read_csv("01_DATOS/indmoraV2_CPT1_Cluster25AT1_KOnaive_vs_controlWTnaive.csv")
...
pdf("volcano_AT1_KOnaive_vs_controlWTnaive.pdf", width = 18, height = 15)
...
#sinnombredegenes
pdf("volcano_AT1_KOnaive_vs_controlWTnaive_sin_nombres.pdf", width = 18, height = 15)
EnhancedVolcano(DEG, x = "avg_log2FC", y = "adj_P_val",
                lab = DEG$`Gene Symbol`,
                xlab = bquote(~avg_log2FC),
                ylab = bquote(~-log[10]~ adj_P_val),
