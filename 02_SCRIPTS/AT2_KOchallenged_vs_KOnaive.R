...
DEG_file <- read_csv("01_DATOS/indmoraV2_CPT1_Cluster1and16and34AT2_KOchallenged_vs_KOnaive.csv")
...
tiff("volcano_AT2_KOchallenged_vs_KOnaive.tiff",
...
#Sinombredegenes
tiff("volcano_AT2_KOchallenged_vs_KOnaive_sin_nombres.tiff",
     res=300, width = 18, height = 15, units = 'in')
EnhancedVolcano(DEG, x = "avg_log2FC", y = "adj_P_val",
                lab = DEG$`Gene Symbol`,
                xlab = bquote(~avg_log2FC),
